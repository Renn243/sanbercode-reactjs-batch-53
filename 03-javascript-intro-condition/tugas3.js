...
let namaLengkap = "Muhammad Raihan Resa";
console.log(namaLengkap);


//Soal 2 (Latihan pengabungan variable)
let word = 'JavaScript';
let second = 'is';
let third = 'awesome';
...
//Soal 3 (Latihan pengabungan variable menggunakan template literals)
let hello = "Hello ";
let world = "World!!";
...
//Soal 5 (Latihan mengurangi kalimat)
...
let hasil = txt.slice(0, 25);

console.log(hasil);


//Soal 8 (<embuat kondisi sederhana)
var nilaiDoe = 50;
...
let hasil2 = (angka === 2) ? "angka nya 2" : "bukan angka 2";
